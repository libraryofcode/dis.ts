...
export default class Client {
  ...
  addGuildMember(guildID: string, userID: string, params: any = {}) {
    return this.requester.request('PUT', Endpoints.GUILD_MEMBER(guildID, userID), true, {
  ...
  addGuildMemberRole(guildID: string, userID: string, roleID: string) {
    return this.requester.request('PUT', Endpoints.GUILD_MEMBER_ROLE(guildID, userID, roleID), true);
  }

  addGroupDMRecipient(channelID: string, userID: string, params: any = {}) {
    return this.requester.request('PUT', Endpoints.GROUP_DM_RECIPIENT(channelID, userID), false, {
      access_token: params.accessToken,
      nick: params.nick,
    });
  }
  ...
  addPinnedChannelMessage(channelID: string, messageID: string) {
    return this.requester.request('PUT', Endpoints.CHANNEL_PINNED_MESSAGE(channelID, messageID), true);
  }

  beginGuildPrune(guildID: string, params: any = {}) {
    return this.requester.request('POST', Endpoints.GUILD_PRUNE(guildID), true, {
      days: params.days,
  ...
  bulkDeleteMessages(channelID: string, messageIDs: string[]) {
    return this.requester.request('POST', Endpoints.CHANNEL_MESSAGES_BULK_DELETE(channelID), true, { messages: messageIDs });
  }

  createChannelInvite(channelID: string, params: any = {}) {
    return this.requester.request('POST', Endpoints.CHANNEL_INVITES(channelID), true, {
  ...
  createGuildBan(guildID: string, userID: string, params: any = {}) {
    return this.requester.request('PUT', Endpoints.GUILD_BAN(guildID, userID), true, {
  ...
  createGuildChannel(guildID: string, params: any = {}) {
    return this.requester.request('POST', Endpoints.GUILD_CHANNEL(guildID), true, {
      name: params.name,
      type: params.type,
      topic: params.topic,
  ...
  createMessage(channelID: string, params: any = {}) { // TODO Sort out multipart form data
    return this.requester.request('POST', Endpoints.CHANNEL_MESSAGES(channelID), true, {
  ...
  crosspostMessage(channelID: string, messageID: string) {
    return this.requester.request('POST', Endpoints.CHANNEL_MESSAGE_CROSSPOST(channelID, messageID), true);
  }

  deleteAllReactions(channelID: string, messageID: string) {
    return this.requester.request('DELETE', Endpoints.CHANNEL_MESSAGE_REACTIONS(channelID, messageID), true);
  }

  deleteAllReactionsEmoji(channelID: string, messageID: string, emoji: string) {
    return this.requester.request('DELETE', Endpoints.CHANNEL_MESSAGE_REACTIONS_EMOJI(channelID, messageID, emoji), true);
  }

  deleteChannel(channelID: string) {
    return this.requester.request('DELETE', Endpoints.CHANNEL(channelID), true);
  }

  deleteChannelPermission(channelID: string, overwriteID: string) {
    return this.requester.request('DELETE', Endpoints.CHANNEL_OVERWRITE_PERMISSIONS(channelID, overwriteID), true);
  }

  deleteGuild(guildID: string) {
    return this.requester.request('DELETE', Endpoints.GUILD(guildID), true);
  }

  deleteGuildEmoji(guildID: string, emojiID: string) {
    return this.requester.request('DELETE', Endpoints.GUILD_EMOJI(guildID, emojiID), true);
  }

  deleteGuildIntegration(guildID: string, integrationID: string) {
    return this.requester.request('DELETE', Endpoints.GUILD_INTEGRATION(guildID, integrationID), true);
  }
  ...
  deleteMessage(channelID: string, messageID: string) {
    return this.requester.request('DELETE', Endpoints.CHANNEL_MESSAGE(channelID, messageID), true);
  }

  deletePinnedChannelMessage(channelID: string, messageID: string) {
    return this.requester.request('DELETE', Endpoints.CHANNEL_PINNED_MESSAGE(channelID, messageID), true);
  }
  ...
  editChannel(channelID: string, params: any = {}) {
    return this.requester.request('PATCH', Endpoints.CHANNEL(channelID), true, {
      name: params.name,
      type: params.type,
      position: params.position,
      topic: params.topic,
  ...
  editChannelPermissions(channelID: string, overwriteID: string, params: any = {}) {
    return this.requester.request('PUT', Endpoints.CHANNEL_OVERWRITE_PERMISSIONS(channelID, overwriteID), true, params);
  }

  editGuild(guildID: string, params: any = {}) {
    return this.requester.request('PATCH', Endpoints.GUILD(guildID), true, {
      name: params.name,
      region: params.region,
      verification_level: params.verificationLevel,
      default_message_notifications: params.defaultMessageNotifications,
  ...
  editGuildChannelPositions(guildID: string, params: any = []) {
    return this.requester.request('PATCH', Endpoints.GUILD_CHANNEL(guildID), true, params);
  }

  editGuildEmoji(guildID: string, emojiID: string, params: any = {}) {
    return this.requester.request('PATCH', Endpoints.GUILD_EMOJI(guildID, emojiID), true, params);
  }

  editGuildIntegration(guildID: string, integrationID: string, params: any = {}) {
    return this.requester.request('PATCH', Endpoints.GUILD_INTEGRATION(guildID, integrationID), true, {
  ...
  editGuildMember(guildID: string, userID: string, params: any = {}) {
    return this.requester.request('PATCH', Endpoints.GUILD_MEMBER(guildID, userID), true, {
      nick: params.nick,
      roles: params.roles,
      mute: params.mute,
      deaf: params.deaf,
  ...
  editGuildMemberNickSelf(guildID: string, nick?: string | null) {
    return this.requester.request('PATCH', Endpoints.GUILD_SELF_NICK(guildID), true, { nick });
  }

  editGuildRole(guildID: string, roleID: string, params: any = {}) {
    return this.requester.request('PATCH', Endpoints.GUILD_ROLE(guildID, roleID), true, params);
  }
  ...
  followNewsChannel(channelID: string, webhookChannelID: string) {
    return this.requester.request('POST', Endpoints.FOLLOW_NEWS_CHANNEL(channelID), true, { webhook_channel_id: webhookChannelID });
  }

  getChannel(channelID: string) {
    return this.requester.request('GET', Endpoints.CHANNEL(channelID), true);
  }

  getChannelInvites(channelID: string) {
    return this.requester.request('GET', Endpoints.CHANNEL_INVITES(channelID), true);
  }

  getChannelMessage(channelID: string, messageID: string) {
    return this.requester.request('GET', Endpoints.CHANNEL_MESSAGE(channelID, messageID), true);
  }
  ...
  getGuild(guildID: string, withCounts?: boolean) {
    return this.requester.request('GET', Endpoints.GUILD(guildID), true, { with_counts: withCounts });
  }

  getGuildAuditLog(guildID: string, params: any = {}) {
    return this.requester.request('GET', Endpoints.GUILD_AUDIT_LOG(guildID), true, {
  ...
  getGuildBan(guildID: string, userID: string) {
    return this.requester.request('GET', Endpoints.GUILD_BAN(guildID, userID), true);
  }

  getGuildBans(guildID: string) {
    return this.requester.request('GET', Endpoints.GUILD_BANS(guildID), true);
  }

  getGuildChannels(guildID: string) {
    return this.requester.request('GET', Endpoints.GUILD_CHANNEL(guildID), true);
  }

  getGuildEmoji(guildID: string, emojiID: string) {
    return this.requester.request('GET', Endpoints.GUILD_EMOJI(guildID, emojiID), true);
  }

  getGuildEmojis(guildID: string) {
    return this.requester.request('GET', Endpoints.GUILD_EMOJIS(guildID), true);
  }

  getGuildIntegrations(guildID: string) {
    return this.requester.request('GET', Endpoints.GUILD_INTEGRATIONS(guildID), true);
  }

  getGuildInvites(guildID: string) {
    return this.requester.request('GET', Endpoints.GUILD_INVITES(guildID), true);
  }

  getGuildMember(guildID: string, userID: string) {
    return this.requester.request('GET', Endpoints.GUILD_MEMBER(guildID, userID), true);
  }

  getGuildMembers(guildID: string, params: any = {}) {
    return this.requester.request('GET', Endpoints.GUILD_MEMBERS(guildID), true, params);
  }

  getGuildPreview(guildID: string) {
    return this.requester.request('GET', Endpoints.GUILD_PREVIEW(guildID), true);
  }

  getGuildPruneCount(guildID: string, params: any = {}) {
    return this.requester.request('GET', Endpoints.GUILD_PRUNE(guildID), true, {
      days: params.days,
      include_roles: params.includeRoles,
    });
  }
  ...
  getGuildWidget(guildID: string) {
    return this.requester.request('GET', Endpoints.GUILD_WIDGET_JSON(guildID), false);
  }

  getGuildWidgetImage(guildID: string, style?: WIDGET_STYLE_OPTIONS) {
    return this.requester.request('GET', Endpoints.GUILD_WIDGET_IMAGE(guildID), false, { style });
  }

  getGuildWidgetSettings(guildID: string) {
    return this.requester.request('GET', Endpoints.GUILD_WIDGET(guildID), true);
  }

  getInvite(code: string, withCounts?: boolean) {
    return this.requester.request('GET', Endpoints.INVITE(code), false, { with_counts: withCounts });
  }

  getPinnedMessages(channelID: string) {
    return this.requester.request('GET', Endpoints.CHANNEL_PINNED_MESSAGES(channelID), true);
  }
  ...
  removeGuildBan(guildID: string, userID: string) {
    return this.requester.request('DELETE', Endpoints.GUILD_BAN(guildID, userID), true);
  }

  removeGuildMember(guildID: string, userID: string) {
    return this.requester.request('DELETE', Endpoints.GUILD_MEMBER(guildID, userID), true);
  }

  removeGuildMemberRole(guildID: string, userID: string, roleID: string) {
    return this.requester.request('DELETE', Endpoints.GUILD_MEMBER_ROLE(guildID, userID, roleID), true);
  }
  ...
  triggerTypingIndicator(channelID: string) {
    return this.requester.request('POST', Endpoints.CHANNEL_TYPING(channelID), true);
  }
}
